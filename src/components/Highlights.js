        ...
        <div class="container">
          <div class="row g-3">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card h-100" style={{ background: "#f2efef" }}>
                <img src={bruchetta} class="card-img-top img-fluid" alt="..." />
                <div class="card-body">
                  <h5 class="card-title">
                    Bruchetta
                    <span style={{ marginLeft: 45 + "%", color: "#FFBC7D" }}>
                      $ 12.99
                    </span>
                  </h5>
                  <p class="card-text">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card h-100" style={{ background: "#f2efef" }}>
                ...
                <div class="card-body">
                  <h5 class="card-title">
                    Greek Salad
                    <span style={{ marginLeft: 40 + "%", color: "#FFBC7D" }}>
                      $ 12.99
                    </span>
                  </h5>
                  <p class="card-text">
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card h-100" style={{ background: "#f2efef" }}>
                <img src={pasta} class="card-img-top img-fluid" alt="..." />
                <div class="card-body">
                  <h5 class="card-title">
                    Pasta
                    <span style={{ marginLeft: 55 + "%", color: "#FFBC7D" }}>
                      $ 12.99
                    </span>
                  </h5>
                  <p class="card-text">
